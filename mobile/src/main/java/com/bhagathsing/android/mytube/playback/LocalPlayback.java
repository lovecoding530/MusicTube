 ...
 */
package com.bhagathsing.android.mytube.playback;
...
import com.bhagathsing.android.mytube.MusicService;
...
import com.bhagathsing.android.mytube.ui.SearchableActivity;
        ...
        if (mediaHasChanged || mExoPlayer == null) {
            ...
            final DataSource.Factory dataSourceFactory =
                    new DefaultDataSourceFactory(
                            mContext, Util.getUserAgent(mContext, "mytube"), null);
                ...
                new YouTubeExtractor(MyApplication.getAppContext()) {
                    ...
                    public void onExtractionComplete(SparseArray<YtFile> ytFiles, VideoMeta vMeta) {
                        if (ytFiles != null) {
                            ...
                            MediaSource mediaSource =
                                    new ExtractorMediaSource(
                                            Uri.parse(downloadUrl), dataSourceFactory, extractorsFactory, null, null);
